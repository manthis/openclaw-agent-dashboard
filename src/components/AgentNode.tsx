      ...
      <div className="relative">
        {isActive && (
          <div
            ...
            style={{
              background: 'conic-gradient(from 0deg, transparent 0%, #22c55e 50%, transparent 100%)',
        ...
        <div className="w-14 h-14 rounded-full overflow-hidden flex items-center justify-center bg-gray-100 dark:bg-neutral-800 border border-gray-300 dark:border-neutral-600 shrink-0 relative z-10">
        {showAvatar ? (
          <img
