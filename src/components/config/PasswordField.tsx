    ...
    <div className="space-y-1">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="flex-1 bg-gray-50 dark:bg-slate-800 border border-gray-300 dark:border-slate-700 rounded-lg px-3 py-2 text-sm text-gray-900 dark:text-white focus:outline-none focus:border-indigo-500"
        />
        <button
          type="button"
